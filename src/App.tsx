               ...
               <div className="flex items-center gap-3 shrink-0 mt-1">
                  ...
                  <div className="flex flex-col gap-1.5 shrink-0">
                    ...
                    <button
                      onClick={() => {
                        if (!aiAnswer) return;
                        clipboard.writeText(aiAnswer.replace(/<think>[\s\S]*?(?:<\/think>|$)/g, '').trim());
                        setAiCopied(true);
                ...
                <h3 className="text-lg font-bold text-white">How to get API Keys (Free)</h3>
                    ...
                    <div className="space-y-2">
                      ...
                      <ol className="text-brand-subtext text-xs leading-relaxed space-y-2 list-decimal pl-4">
                        <li>Go to <a href="#" onClick={(e) => { e.preventDefault(); shell.openExternal('https://console.groq.com/keys'); }} className="text-blue-400 hover:underline">console.groq.com/keys</a> and log in.</li>
                    ...
                    <div className="space-y-2">
                      ...
                      <ol className="text-brand-subtext text-xs leading-relaxed space-y-2 list-decimal pl-4">
                        <li>Go to <a href="#" onClick={(e) => { e.preventDefault(); shell.openExternal('https://aistudio.google.com/app/apikey'); }} className="text-blue-400 hover:underline">aistudio.google.com/app/apikey</a> and log in.</li>
                    ...
                    <div className="space-y-2">
                      ...
                      <ol className="text-brand-subtext text-xs leading-relaxed space-y-2 list-decimal pl-4">
                        <li>Go to <a href="#" onClick={(e) => { e.preventDefault(); shell.openExternal('https://console.anthropic.com/settings/keys'); }} className="text-blue-400 hover:underline">console.anthropic.com/settings/keys</a> and log in.</li>
                    ...
                    <div className="space-y-2">
                      ...
                      <ol className="text-brand-subtext text-xs leading-relaxed space-y-2 list-decimal pl-4">
                        <li>Go to <a href="#" onClick={(e) => { e.preventDefault(); shell.openExternal('https://platform.openai.com/api-keys'); }} className="text-blue-400 hover:underline">platform.openai.com/api-keys</a> and log in.</li>
                    ...
                    <div className="space-y-2 md:col-span-2 lg:col-span-1">
                      ...
                      <ol className="text-brand-subtext text-xs leading-relaxed space-y-2 list-decimal pl-4">
                        <li>Go to <a href="#" onClick={(e) => { e.preventDefault(); shell.openExternal('https://platform.deepseek.com/api_keys'); }} className="text-blue-400 hover:underline">platform.deepseek.com/api_keys</a> and log in.</li>
