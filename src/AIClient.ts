...
- Use bullet points or short paragraphs for readability. DO NOT output one massive paragraph.
...
- If asked about differences or comparisons, you MUST use bullet points and put both sides of the comparison into the SAME bullet point (e.g., "- A chargeable mouse has a built-in battery, but an unchargeable mouse needs AA batteries replaced frequently").
